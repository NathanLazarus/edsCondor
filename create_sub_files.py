...
arguments               = EDSfit.py
transfer_input_files    = EDSfit.py, k_coefs.npy, {}
...
executable              = python
transfer_executable     = False
arguments               = EDSfit.py initialize
transfer_input_files    = EDSfit.py
should_transfer_files   = YES
when_to_transfer_output = ON_EXIT
output                  = outfiles/fit$(Cluster).out
error                   = outfiles/fit$(Cluster).err
...
executable              = python
transfer_executable     = False
arguments               = EDSsim.py $(Process)
transfer_input_files    = EDSsim.py, k_coefs.npy
should_transfer_files   = YES
when_to_transfer_output = ON_EXIT
